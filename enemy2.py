...
class Enemy2(pygame.sprite.Sprite):
    def __init__(self, pos,screen_width,screen_height, player_pos):
        ...
        fire_front1 = pygame.image.load('graphics/sprites/Fire/front1.png').convert_alpha()
        fire_front2 = pygame.image.load('graphics/sprites/Fire/front2.png').convert_alpha()
        fire_front3 = pygame.image.load('graphics/sprites/Fire/front3.png').convert_alpha()
        fire_front4 = pygame.image.load('graphics/sprites/Fire/front4.png').convert_alpha()
        ...
        fire_back1 = pygame.image.load('graphics/sprites/Fire/back1.png').convert_alpha()
        fire_back2 = pygame.image.load('graphics/sprites/Fire/back2.png').convert_alpha()
        fire_back3 = pygame.image.load('graphics/sprites/Fire/back3.png').convert_alpha()
        fire_back4 = pygame.image.load('graphics/sprites/Fire/back4.png').convert_alpha()
        ...
        fire_left1 = pygame.image.load('graphics/sprites/Fire/left1.png').convert_alpha()
        fire_left2 = pygame.image.load('graphics/sprites/Fire/left2.png').convert_alpha()
        fire_left3 = pygame.image.load('graphics/sprites/Fire/left3.png').convert_alpha()
        fire_left4 = pygame.image.load('graphics/sprites/Fire/left4.png').convert_alpha()
        ...
        fire_right1 = pygame.image.load('graphics/sprites/Fire/right1.png').convert_alpha()
        fire_right2 = pygame.image.load('graphics/sprites/Fire/right2.png').convert_alpha()
        fire_right3 = pygame.image.load('graphics/sprites/Fire/right3.png').convert_alpha()
        fire_right4 = pygame.image.load('graphics/sprites/Fire/right4.png').convert_alpha()
